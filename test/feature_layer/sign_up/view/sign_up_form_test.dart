...
void main() {
  ...
  group('SignUpForm', () {
    ...
    setUp(() {
      ...
      when(() => signUpCubit.onSignUpFormSubmitted()).thenAnswer((_) async {});
    });
    ...
    group('calls', () {
      testWidgets('emailChanged when email changes', (tester) async {
        ...
        verify(() => signUpCubit.onEmailChanged(testEmail)).called(1);
      });
      ...
      testWidgets('passwordChanged when password changes', (tester) async {
        ...
        verify(() => signUpCubit.onPasswordChanged(testPassword)).called(1);
      });
      ...
      testWidgets('confirmedPasswordChanged when confirmedPassword changes',
        ...
        verify(
          () => signUpCubit.onConfirmedPasswordChanged(testConfirmedPassword),
        ).called(1);
      });
      ...
      testWidgets('signUpFormSubmitted when sign up button is pressed',
        ...
        verify(() => signUpCubit.onSignUpFormSubmitted()).called(1);
      });
    });
